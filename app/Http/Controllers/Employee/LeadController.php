...
class LeadController extends Controller {
    ...
    public function edit_leads($id = null) {
        ...
        return view('employee.lead.create', compact('result'));
    }
    public function open_leads() {  
       return view('employee.lead.open-lead');  
    }
    public function  store(Request $request) {
        ...
        try {
            ...
            return redirect()->route('leads.add_leads')
    ...
    public function empOpenleadPaginate(Request $request, $pageNumber = null) {
      //  dd($request);
         ...
         // dd($data);
          ...
          return view('employee.lead.load_data', compact('inputs', 'data', 'total', 'page', 'perPage'));
      }
    ...
    public function empCloseleadPaginate(Request $request, $pageNumber = null) {
      //  dd($request);
         ...
         // dd($data);
          ...
          return view('employee.lead.close_load_data', compact('inputs', 'data', 'total', 'page', 'perPage'));
      }
    ...
    public function closed_leads(){
        return view('employee.lead.closed-lead');
    }

    public function social(){
        return view('employee.lead.social');
    }

    public function admin_lead_page(){
        return view('employee.lead.lead-tracking');
     }
    ...
    public function admin_lead_popup(Request $request)
    {
        ...
        $artilces = '';
        if (!empty($results->id)){
            $datas=['status'=>200,'responce'=>$results,'getuser'=>$get_user];
