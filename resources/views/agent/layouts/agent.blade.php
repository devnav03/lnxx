    ...
    <div class="main-header side-header sticky">
      ...
      <!--       <div class="main-header-center">
                <div class="responsive-logo">
                    <a href="index.html"><img src="{{ asset('img/lnxx_logo.png')}}" class="mobile-logo" alt="logo"></a>
                    <a href="index.html"><img src="{{ asset('img/lnxx_logo.png')}}" class="mobile-logo-dark" alt="logo"></a>
                </div>
                                ...
                                <div class="dropdown-menu">
                                    <a href="javascript:void(0)" class="dropdown-item d-flex ">
                                        <span class="avatar  me-3 align-self-center bg-transparent"><img
                                                src="{{ asset('img/flags/french_flag.jpg') }}" alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0)" class="dropdown-item d-flex">
                                        <span class="avatar  me-3 align-self-center bg-transparent"><img
                                                src="{{ asset('img/flags/germany_flag.jpg') }}" alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0)" class="dropdown-item d-flex">
                                        <span class="avatar me-3 align-self-center bg-transparent"><img
                                                src="{{ asset('img/flags/italy_flag.jpg') }}" alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0)" class="dropdown-item d-flex">
                                        <span class="avatar me-3 align-self-center bg-transparent"><img
                                                src="{{ asset('img/flags/russia_flag.jpg') }}" alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0)" class="dropdown-item d-flex">
                                        <span class="avatar  me-3 align-self-center bg-transparent"><img
                                                src="{{ asset('img/flags/spain_flag.jpg') }}" alt="img"></span>
                                        <div class="d-flex">
                            ...
                            <div class="dropdown main-header-notification">
                               ...
                               <div class="dropdown-menu">
                                    <div class="main-notification-list">
                                        @foreach($NoteDate as $NoteDate)
                                        <div class="media new">
                                            <div class="media-body">
                                                <p>Follow Up<strong> {{$NoteDate->name}} </strong> for {{$NoteDate->product}} </p>
                                                <span>{{$NoteDate->f_date}} </span>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  <!--   <a class="dropdown-item border-top" href="profile.html">
                                   ...
                                   <!--  <a class="dropdown-item" href="profile.html">
                                    ...
                                    <a class="dropdown-item" href="{{ route('logout-employee') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                        <i class="fe fe-power"></i> Sign Out
                                    </a>
                                    <form id="logout-form" action="{{ route('logout-employee') }}" method="POST" class="d-none">
                                        @csrf
                                    </form>
                                </div>
                            </div>
