...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg" style="max-width: 1300px;">
        <div class="modal-content">
            <div class="modal-header" style="width: 1300px; height: 104px; left: 0px; top: 0px; background: #F3F0F1;">
            ...
            <div style="height: 104px; margin: 25px 0px -45px 0px; background:#fff;">
                <div class="row" style="margin-right: 0px; margin-left: 0px;">
                    <div class="col-md-1" style="line-height:5.6px; margin-top: 5px;">
                        <p style="weight:700; font-size:15px;"><b>Title</b></p>
                                                    ...
                                                    <div class="tab-content" id="nav-tabContent">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" id="m_createdat"
                                                                            disabled>
                                                                    </div>
                                                                </div>
                                                                <!-- <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label><b>Starting Time</b></label>
                                                        ...
                                                        <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label><b>Lead Reference</b></label>
                ...
                if (xhr.status == 200) {
                    ...
                    if (xhr.responce.lead_status == 'INPROCESS') {
                        $("#status_bar").html(
                            ...
                            ')"><div style="width:200px; height:30px; background-color:#058D3D; position:relative; border-radius: 0px 15px 15px 0px;"><div style="width: 0;height: 0;position:absolute;right: -24px;"><h6 style="margin: 7px 0px 0px -180px; color: #fff!important; font-size: 12px;">Set status as Complete</h6></div></div></a></div><div class="col-sm-1"><div class="form-group" id="markascomplete"><button onclick="show_case_detail()" type="button" class="btn btn-primary btn-lg" style="margin: -10px -100px 0px 0px; background-color:#3D6AD6;"><i class="ti-alarm-clock menu-icon"></i> History </button></div></div><div class="col-sm-1"><div class="form-group" id="markascomplete"><button onclick="show_mail_datails()" type="button" class="btn btn-primary btn-lg" style="margin: -10px -135px 0px 72px; background-color:#3D6AD6; "><i class="ti-email menu-icon"></i> Mail</button></div></div>'
                            );
                    }
                    if (xhr.responce.lead_status == 'REMINDER') {
                        $("#status_bar").html(
