...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header">Create Lead @if($route == 'lead.create')<button type="button" class="btn tn-sm btn-primary pull-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-solid fa-arrow-up"></i>Bulk Upload Leads</button>
                @elseif($route == 'leads.add_leads')<button type="button" class="btn tn-sm btn-primary pull-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-solid fa-arrow-up"></i>Bulk Upload Leads</button>@elseif($route == 'agent.leads.add_leads')<button type="button" class="btn tn-sm btn-primary pull-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-solid fa-arrow-up"></i>Bulk Upload Leads</button>@elseif($route == 'manager.leads.add_leads')<button type="button" class="btn tn-sm btn-primary pull-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-solid fa-arrow-up"></i>Bulk Upload Leads</button>@endif</h1>
                        ...
                        <div class="form-grids widget-shadow" data-example-id="basic-forms"> 
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group"> 
                                            {!! Form::label('reference', lang('Reference ID'), array('class' => '')) !!}
