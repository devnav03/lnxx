...
<div class="agile-grids">
    <div class="grids">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header">Emloyee List</h1>
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                            ...
                            <div class="row row-sm">
                                <div class="col-lg-12 col-md-12">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div>
                                                <h6 class="main-content-label mb-1">Employee Filter</h6>
                                            </div>
                                            <div class="panel-body row">
                                                <div class="col-md-12" style="margin-top: 15px;">
                                                    {!! Form::open(array('method' => 'POST',
                                                    'route' => array('employees.paginate'), 'id' => 'ajaxForm')) !!}
                                                    <div class="row">
                                                        <div class="col-sm-3">
                        ...
                        <form action="{{ route('employees.action') }}" method="post">
                            <!--     <div class="row"> -->
                            <div class="col-md-3 pull-right padding0" style="text-align: right; margin-bottom: 15px;">
                                {!! lang('Show') !!} {!! Form::select('name', ['20' => '20', '40' => '40', '100' =>
                                '100', '200' => '200', '300' => '300'], '20', ['id' => 'per-page']) !!} {!!
                                lang('entries') !!}
                            </div>
                            ...
                            <!--  </div> -->
                            <table id="paginate-load" data-route="{{route('employees.paginate')}}"
