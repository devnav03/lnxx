  ...
  <div class="row">  
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input name="first_name_as_per_passport" class="form-control" value="{{ old('first_name_as_per_passport') }}" type="text" pattern="(?=^.{2,25}$)(?![.\n])(?=.*[a-zA-Z]).*$" required="true">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input name="middle_name" class="form-control" value="{{ old('middle_name') }}" type="text" pattern="(?=^.{2,25}$)(?![.\n])(?=.*[a-zA-Z]).*$">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input name="last_name" class="form-control" value="{{ old('last_name') }}" type="text" pattern="(?=^.{2,25}$)(?![.\n])(?=.*[a-zA-Z]).*$">
