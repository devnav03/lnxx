...
@if($route == 'user-dashboard' || $route == 'personal-details' || $route == 'cm-details' || $route == 'product-requested' || $route == 'address-details' || $route ==  'select-services' || $route == 'thank-you' || $route == 'record-video' || $route == 'consent-approval') 
